    ...
    <div class="row" >
        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body h-100" style="background-color:rgb(248, 196, 231) ;font-size:1.3rem">
                    <h3 style="color: rgb(5, 122, 19);font-family: Cairo" class="text-center">
                        <i class="text-warning"></i> &nbsp;{{trans('quizze.quizze.question')}}
                    </h3><br><br><br>
                        <form method="POST" action="{{route('questions.store')}}" class="text-primary">
                            @csrf
                            <div class="form-row">
