                ...
                @method('PATCH')
                    ...
                    <div class="form-row">
                        <div class="col-md-3">
                            ...
                            <input type="text" name="teacher_name" class="form-control" value="{{$teacher->getTranslation('name','ar')}}">
                            @error('teacher_name')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="teacher_date" class="form-control" value="{{$teacher->join_date}}" id="datepicker-action"  data-date-format="yyyy-mm-dd"  required>
                            @error('teacher_date')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="teacher_phone" class="form-control"  value="{{$teacher->phone}}" >
                            @error('teacher_phone')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="custom-select my-1 mr-sm-2" name="teacher_specialization">
                                <option selected  value="{{$teacher->specialization}}" >{{$teacher->specializations->name}}</option>
                        ...
                        <div class="form-group col">
                            ...
                            <select class="custom-select my-1 mr-sm-2" name="teacher_gender">
                                <option selected  value="{{$teacher->gender}}" >{{$teacher->genders->name}}</option>
