        ...
        <div class="row">
            ...
            <div class="table-responsive" >
                <form action="{{route('attendance.store')}}" method="POST">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td >
                                    ...
                                    @endif
                                    <a href="#" class="btn-sm btn-info ml-4"><i class="fa fa-edit pr-2"></i>{{trans('grades.edit')}}</a>
                    ...
                    <input type="submit" value="{{trans('generals.data.save')}}" class="btn btn-success px-4 m-3">
                </form>
            </div>
        </div>
     </div>
