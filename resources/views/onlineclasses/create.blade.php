    ...
    <div class="row" >
        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body h-100" style="background-color:rgb(242, 201, 201);font-size:1.3rem ">
                    <h3 style="color: rgb(145, 21, 23);font-family: Cairo;" class="text-center">
                        <i class="fa fa-book text-warning"></i> &nbsp;{{trans('zoom.session.add')}}
                    </h3><br><br><br>
                        <form method="POST" action="{{route('online-courses.store')}}" class="text-primary">
                            @csrf
                            <div class="form-row">
                                <div class="form-group col-4">
                                    <label for="inputState">{{trans('zoom.session.title')}} :
                                     <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="topic">
                                </div>
                                <div class="form-group col-4">
                                    <label for="inputState">{{trans('zoom.session.start')}} :
                                     <span class="text-danger">*</span></label>
                                    <input type="datetime-local" class="form-control" name="start_at">
                                </div>
                                <div class="form-group col-4">
                                    <label for="inputState">{{trans('zoom.session.time')}} :
                                     <span class="text-danger">*</span></label>
